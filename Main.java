...
public class Main {
    public static void main(String[] args) {
        ...
        Aluno aluno1 = new Aluno(1, "Dimitri", "8888", "202111230","d.lbck@gmail.com","22998872372");
        Aluno aluno2 = new Aluno(1, "Carol", "11111", "202111230","d.lbck@gmail.com","22998872372");
        Aluno aluno3 = new Aluno(2,"Gabriel","dddddd","12345678", "gahbahbcs" , "1928777");
        Professor prof1 = new Professor(2, "renata", "22222", "gggggggg", "234568");

        AlunoNaDisciplina aluno1E = new AlunoNaDisciplina(aluno1);
        aluno1E.fazerMatriculaDisciplina(disciplina1);
        aluno1E.fazerMatriculaDisciplina(disciplina2);
        aluno1E.fazerMatriculaDisciplina(disciplina3);
...
//        gestor1.adicionarProfessor(prof1);
